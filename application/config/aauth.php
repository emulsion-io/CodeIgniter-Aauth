...
|   ['use_password_hash']               Enables password_hash() and transparent migration of valid legacy hashes on login
|   ['password_hash_algo']              password_hash algorithm (PASSWORD_DEFAULT, PASSWORD_BCRYPT, PASSWORD_ARGON2ID)
